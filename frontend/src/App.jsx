...
function MenuPrincipal() {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#1e3a5f] text-slate-100 relative z-10 overflow-hidden">
      ...
      <h1 className="text-5xl md:text-7xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-white to-amber-200 drop-shadow-md text-center px-4">
        Torneo Interfarmacéutico 2026
      </h1>
      <p className="text-xl md:text-2xl text-sky-200 font-bold mb-12 tracking-widest uppercase text-center px-4">Gran Sorteo Inaugural • Edición Especial Mate</p>
