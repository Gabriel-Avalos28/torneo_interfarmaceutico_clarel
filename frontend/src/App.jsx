...
function MenuPrincipal() {
  return (
    <div className="flex flex-col items-center justify-center h-screen bg-[#1e3a5f] text-slate-100 relative z-10 overflow-hidden">
      ...
      <h1 className="text-4xl sm:text-5xl md:text-7xl font-black mb-4 text-transparent bg-clip-text bg-gradient-to-r from-amber-300 via-white to-amber-200 drop-shadow-md text-center px-4 relative z-10">
        Torneo Interfarmacéutico Clarel 2026
      </h1>
      <p className="text-xl md:text-2xl text-sky-200 font-bold mb-12 tracking-widest uppercase text-center px-4 relative z-10">Gran Sorteo Inaugural</p>

      <div className="flex flex-col md:flex-row gap-8 relative z-10">

        <Link to="/publico" className="px-6 py-4 sm:px-10 sm:py-5 bg-gradient-to-r from-[#2563eb] to-[#3b82f6] text-white hover:scale-105 rounded-3xl font-black text-xl sm:text-2xl transition-all shadow-[0_12px_35px_rgba(37,99,235,0.45)] hover:shadow-[0_18px_45px_rgba(37,99,235,0.65)] text-center border-2 border-sky-300">
      ...
      <img
        ...
        className="absolute bottom-0 left-0 w-24 sm:w-48 md:w-72 lg:w-96 object-contain drop-shadow-[0_10px_25px_rgba(0,0,0,0.5)] transition-transform duration-500 hover:scale-105 origin-bottom-left z-0 opacity-95 hidden sm:block"
      />
      ...
      <div className="absolute bottom-6 right-6 md:bottom-10 md:right-10 flex flex-col items-center gap-2 z-0 opacity-90 hover:opacity-100 transition-opacity">
        ...
        <img
          ...
          className="w-24 sm:w-32 md:w-48 lg:w-56 object-contain drop-shadow-[0_8px_20px_rgba(0,0,0,0.4)] hover:scale-105 transition-transform duration-300"
        />
      </div>
    </div>
  );
